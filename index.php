...
<?php
	...
	while($r = mysql_fetch_array($sql)) {
		...
		echo "<tr><td width=32 style=\"border:1px solid;\"><pre>     </pre></td><td style=\"border:1px solid;\" width=40%><a href=\"viewforum.php?f=" . $r["id"] . "\">$r[name]</a><br>" . $r["desc"] . "</td><td style=\"border:1px solid;\" width=15% align=center>" . $r["topics"] . "<br></td><td style=\"border:1px solid;\" width=15% align=center>" . $r["posts"] . "<br></td><td style=\"border:1px solid;\" width=30% align=center>" . $action . "<br></td></tr>";
		// End of Array
	}
?>
